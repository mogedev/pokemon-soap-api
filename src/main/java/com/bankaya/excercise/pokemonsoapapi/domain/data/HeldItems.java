 ...
 *       &lt;sequence&gt;
 *         &lt;element name="heldItem" type="{http://www.bankaya.com/pokemon-soap-api}heldItemType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class HeldItems {
    ...
    protected List<HeldItemType> heldItem;
     ...
     * 
     */
    public List<HeldItemType> getHeldItem() {
        if (heldItem == null) {
            heldItem = new ArrayList<HeldItemType>();
        }
